...
#define DIALOG_TYPE_MESSEGE_ERR1											4//文件名长度错误
...
#define DIALOG_TYPE_MAINBOAR_ERROR										17
#define DIALOG_TYPE_REPRINT_NO_TEMP                                             18

#define DIALOG_EMPTY_FILAMENT_TIPS          19
