...
void disp_language_init()
{
	...
	about_menu.type = ABOUT_TYPE_TEXT;
	about_menu.version = ABOUT_VERSION_TEXT;
	...
	printing_more_menu.babystep = BABYSTEP_EN;
	...
	switch(gCfgItems.language)
	{
		case LANG_SIMPLE_CHINESE:
			...
			file_menu.no_desire_temp=DIALOG_TEXT_NO_TEMP_TIPS_CN;
			//º∑≥ˆ
			...
			wifi_menu.wifi_state_disable=DIALOG_TEXT_WIFI_DISABLE_CN;
			wifi_menu.wifi_state_enable=DIALOG_TEXT_WIFI_ENABLE_CN;
			wifi_menu.enable_wifi=DIALOG_WIFI_ENABLE_CN;
			wifi_menu.disable_wifi=DIALOG_WIFI_DISABLE_CN;
			//CLOUD
			...
			filament_menu.filamemt_dialog_empty = FILAMENT_DIALOG_EMPTY_TIPS_CN;
			...
			print_file_dialog_menu.defaulty=DIALOG_TEXT_DEFAULT_TEMP_CN;
			print_file_dialog_menu.setting=DIALOG_TEXT_SETTING_TEMP_CN;
			break;
		#if 1
		case LANG_COMPLEX_CHINESE:
			...
			file_menu.no_desire_temp=DIALOG_TEXT_NO_TEMP_TIPS_T_CN;
			//º∑≥ˆ
			...
			wifi_menu.wifi_state_disable=DIALOG_TEXT_WIFI_DISABLE_T_CN;
			wifi_menu.wifi_state_enable=DIALOG_TEXT_WIFI_ENABLE_T_CN;
			wifi_menu.enable_wifi=DIALOG_WIFI_ENABLE_T_CN;
			wifi_menu.disable_wifi=DIALOG_WIFI_DISABLE_T_CN;
			//CLOUD
			...
			filament_menu.filamemt_dialog_empty = FILAMENT_DIALOG_EMPTY_TIPS_T_CN;
			...
			print_file_dialog_menu.defaulty=DIALOG_TEXT_DEFAULT_TEMP_T_CN;
			print_file_dialog_menu.setting=DIALOG_TEXT_SETTING_TEMP_T_CN;
			break;
		case LANG_ENGLISH:
			...
			file_menu.no_desire_temp=DIALOG_TEXT_NO_TEMP_TIPS_EN;
			//º∑≥ˆ
			...
			wifi_menu.wifi_state_disable=DIALOG_TEXT_WIFI_DISABLE_EN;
			wifi_menu.wifi_state_enable=DIALOG_TEXT_WIFI_ENABLE_EN;
			wifi_menu.enable_wifi=DIALOG_WIFI_ENABLE_EN;
			wifi_menu.disable_wifi=DIALOG_WIFI_DISABLE_EN;
			...
			filament_menu.filamemt_dialog_empty = FILAMENT_DIALOG_EMPTY_TIPS_EN;
			...
			print_file_dialog_menu.defaulty=DIALOG_TEXT_DEFAULT_TEMP_EN;
			print_file_dialog_menu.setting=DIALOG_TEXT_SETTING_TEMP_EN;
			break;
		case LANG_RUSSIAN:
			...
			file_menu.no_desire_temp=DIALOG_TEXT_NO_TEMP_TIPS_RU;
			//º∑≥ˆ
			...
			wifi_menu.wifi_state_disable=DIALOG_TEXT_WIFI_DISABLE_RU;
			wifi_menu.wifi_state_enable=DIALOG_TEXT_WIFI_ENABLE_RU;
			wifi_menu.enable_wifi=DIALOG_WIFI_ENABLE_RU;
			wifi_menu.disable_wifi=DIALOG_WIFI_DISABLE_RU;
			...
			filament_menu.filamemt_dialog_empty = FILAMENT_DIALOG_EMPTY_TIPS_RU;
			...
			print_file_dialog_menu.defaulty=DIALOG_TEXT_DEFAULT_TEMP_RU;
			print_file_dialog_menu.setting=DIALOG_TEXT_SETTING_TEMP_RU;
			break;
		case LANG_SPANISH:
			...
			common_menu.pause_special_title = PRINTING_PAUSE_SP;
			common_menu.operate_special_title = PRINTING_OPERATION_SP;			
			//÷˜“≥√Ê
			...
			file_menu.no_desire_temp=DIALOG_TEXT_NO_TEMP_TIPS_SP;
			//º∑≥ˆ
			...
			wifi_menu.wifi_state_disable=DIALOG_TEXT_WIFI_DISABLE_SP;
			wifi_menu.wifi_state_enable=DIALOG_TEXT_WIFI_ENABLE_SP;
			wifi_menu.enable_wifi=DIALOG_WIFI_ENABLE_SP;
			wifi_menu.disable_wifi=DIALOG_WIFI_DISABLE_SP;
			
			wifi_menu.ip = WIFI_IP_TEXT;
			wifi_menu.wifi = WIFI_NAME_TEXT;
			wifi_menu.key = WIFI_KEY_TEXT_SP;
			wifi_menu.state_ap = WIFI_AP_TEXT_SP;
			wifi_menu.state_sta = WIFI_STA_TEXT_SP;
			wifi_menu.connected = WIFI_CONNECTED_TEXT_SP;
			wifi_menu.disconnected = WIFI_DISCONNECTED_TEXT_SP;
			wifi_menu.exception = WIFI_EXCEPTION_TEXT_SP;
			...
			filament_menu.filamemt_dialog_empty = FILAMENT_DIALOG_EMPTY_TIPS_SP;
			...
			print_file_dialog_menu.defaulty=DIALOG_TEXT_DEFAULT_TEMP_SP;
			print_file_dialog_menu.setting=DIALOG_TEXT_SETTING_TEMP_SP;
			break;
		#endif
		...
		case LANG_FRENCH:
			...
			file_menu.no_desire_temp=DIALOG_TEXT_SETTING_TEMP_FR;
			//WIFI
			wifi_menu.title=WIFI_NAME_TEXT_FR;
			wifi_menu.wifi_state_disable=DIALOG_TEXT_WIFI_DISABLE_FR;
			wifi_menu.wifi_state_enable=DIALOG_TEXT_WIFI_ENABLE_FR;
			wifi_menu.enable_wifi=DIALOG_WIFI_ENABLE_FR;
			wifi_menu.disable_wifi=DIALOG_WIFI_DISABLE_FR;
			...
			filament_menu.filamemt_dialog_empty = FILAMENT_DIALOG_EMPTY_TIPS_FR;
			...
			print_file_dialog_menu.defaulty=DIALOG_TEXT_DEFAULT_TEMP_FR;
			print_file_dialog_menu.setting=DIALOG_TEXT_SETTING_TEMP_FR;
			break;
		...
		case LANG_ITALY:
			...
			file_menu.no_desire_temp=DIALOG_TEXT_NO_TEMP_TIPS_IT;
			//º∑≥ˆ
			...
			wifi_menu.wifi_state_disable=DIALOG_TEXT_WIFI_DISABLE_IT;
			wifi_menu.wifi_state_enable=DIALOG_TEXT_WIFI_ENABLE_IT;
			wifi_menu.enable_wifi=DIALOG_WIFI_ENABLE_IT;
			wifi_menu.disable_wifi=DIALOG_WIFI_DISABLE_IT;
			//πÿ”⁄
			...
			filament_menu.filamemt_dialog_empty = FILAMENT_DIALOG_EMPTY_TIPS_IT;
			...
			print_file_dialog_menu.defaulty=DIALOG_TEXT_DEFAULT_TEMP_IT;
			print_file_dialog_menu.setting=DIALOG_TEXT_SETTING_TEMP_IT;
			break;
			#endif
			#if 0
		case LANG_KOREAN:
