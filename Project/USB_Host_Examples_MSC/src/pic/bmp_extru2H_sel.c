...
static GUI_CONST_STORAGE GUI_COLOR Colorsbmp_extru2H_sel[] = {
...
static GUI_CONST_STORAGE GUI_LOGPALETTE Palbmp_extru2H_sel = {
  256,	/* number of entries */
  0, 	/* No transparency */
  &Colorsbmp_extru2H_sel[0]
};

static GUI_CONST_STORAGE unsigned char acbmp_extru2H_sel[] = {
  /* RLE: 353 Pixels @ 000,000*/ 254, 0x10, 99, 0x10, 
  /* RLE: 011 Pixels @ 033,004*/ 11, 0xFF, 
  /* RLE: 067 Pixels @ 044,004*/ 67, 0x10, 
  /* RLE: 005 Pixels @ 031,005*/ 5, 0xFF, 
  /* RLE: 005 Pixels @ 036,005*/ 5, 0x10, 
  /* RLE: 005 Pixels @ 041,005*/ 5, 0xFF, 
  /* RLE: 063 Pixels @ 046,005*/ 63, 0x10, 
  /* RLE: 004 Pixels @ 029,006*/ 4, 0xFF, 
  /* RLE: 011 Pixels @ 033,006*/ 11, 0x10, 
  /* RLE: 004 Pixels @ 044,006*/ 4, 0xFF, 
  /* RLE: 060 Pixels @ 048,006*/ 60, 0x10, 
  /* RLE: 003 Pixels @ 028,007*/ 3, 0xFF, 
  /* RLE: 006 Pixels @ 031,007*/ 6, 0x10, 
  /* RLE: 004 Pixels @ 037,007*/ 4, 0xFF, 
  /* RLE: 005 Pixels @ 041,007*/ 5, 0x10, 
  /* RLE: 003 Pixels @ 046,007*/ 3, 0xFF, 
  /* RLE: 058 Pixels @ 049,007*/ 58, 0x10, 
  /* RLE: 003 Pixels @ 027,008*/ 3, 0xFF, 
  /* RLE: 006 Pixels @ 030,008*/ 6, 0x10, 
  /* ABS: 006 Pixels @ 036,008*/ 0, 6, 0xFF, 0xFF, 0x10, 0x10, 0xFF, 0xFF, 
  /* RLE: 005 Pixels @ 042,008*/ 5, 0x10, 
  /* RLE: 003 Pixels @ 047,008*/ 3, 0xFF, 
  /* RLE: 057 Pixels @ 050,008*/ 57, 0x10, 
  /* ABS: 002 Pixels @ 027,009*/ 0, 2, 0xFF, 0xFF, 
  /* RLE: 011 Pixels @ 029,009*/ 11, 0x10, 
  /* ABS: 002 Pixels @ 040,009*/ 0, 2, 0xFF, 0xFF, 
  /* RLE: 006 Pixels @ 042,009*/ 6, 0x10, 
  /* ABS: 002 Pixels @ 048,009*/ 0, 2, 0xFE, 0xFF, 
  /* RLE: 057 Pixels @ 050,009*/ 57, 0x10, 
  /* RLE: 003 Pixels @ 027,010*/ 3, 0xFF, 
  /* RLE: 007 Pixels @ 030,010*/ 7, 0x10, 
  /* RLE: 004 Pixels @ 037,010*/ 4, 0xFF, 
  /* RLE: 006 Pixels @ 041,010*/ 6, 0x10, 
  /* RLE: 003 Pixels @ 047,010*/ 3, 0xFF, 
  /* RLE: 057 Pixels @ 050,010*/ 57, 0x10, 
  /* RLE: 004 Pixels @ 027,011*/ 4, 0xFF, 
  /* RLE: 005 Pixels @ 031,011*/ 5, 0x10, 
  /* RLE: 003 Pixels @ 036,011*/ 3, 0xFF, 
  /* RLE: 008 Pixels @ 039,011*/ 8, 0x10, 
  /* RLE: 003 Pixels @ 047,011*/ 3, 0xFF, 
  /* RLE: 058 Pixels @ 050,011*/ 58, 0x10, 
  /* RLE: 004 Pixels @ 028,012*/ 4, 0xFF, 
  /* RLE: 004 Pixels @ 032,012*/ 4, 0x10, 
  /* RLE: 006 Pixels @ 036,012*/ 6, 0xFF, 
  /* RLE: 003 Pixels @ 042,012*/ 3, 0x10, 
  /* RLE: 004 Pixels @ 045,012*/ 4, 0xFF, 
  /* RLE: 061 Pixels @ 049,012*/ 61, 0x10, 
  /* RLE: 003 Pixels @ 030,013*/ 3, 0xFF, 
  /* RLE: 011 Pixels @ 033,013*/ 11, 0x10, 
  /* RLE: 004 Pixels @ 044,013*/ 4, 0xFF, 
  /* RLE: 063 Pixels @ 048,013*/ 63, 0x10, 
  /* RLE: 004 Pixels @ 031,014*/ 4, 0xFF, 
  /* RLE: 007 Pixels @ 035,014*/ 7, 0x10, 
  /* RLE: 004 Pixels @ 042,014*/ 4, 0xFF, 
  /* RLE: 067 Pixels @ 046,014*/ 67, 0x10, 
  /* RLE: 004 Pixels @ 033,015*/ 4, 0xFF, 
  /* RLE: 004 Pixels @ 037,015*/ 4, 0x10, 
  /* RLE: 004 Pixels @ 041,015*/ 4, 0xFF, 
  /* RLE: 069 Pixels @ 045,015*/ 69, 0x10, 
  /* RLE: 009 Pixels @ 034,016*/ 9, 0xFF, 
  /* RLE: 074 Pixels @ 043,016*/ 74, 0x10, 
  /* RLE: 004 Pixels @ 037,017*/ 4, 0xFF, 
  /* RLE: 155 Pixels @ 041,017*/ 155, 0x10, 
  /* RLE: 006 Pixels @ 036,019*/ 6, 0xFF, 
  /* RLE: 075 Pixels @ 042,019*/ 75, 0x10, 
  /* RLE: 004 Pixels @ 037,020*/ 4, 0xFF, 
  /* RLE: 077 Pixels @ 041,020*/ 77, 0x10, 
  /* ABS: 002 Pixels @ 038,021*/ 0, 2, 0xFF, 0xFF, 
  /* RLE: 280 Pixels @ 040,021*/ 254, 0x10, 26, 0x10, 


  0};  /* 156 for 2000 pixels */

GUI_CONST_STORAGE GUI_BITMAP bmbmp_extru2H_sel = {
  80, /* XSize */
  25, /* YSize */
  80, /* BytesPerLine */
  GUI_COMPRESS_RLE8, /* BitsPerPixel */
  acbmp_extru2H_sel,  /* Pointer to picture data (indices) */
  &Palbmp_extru2H_sel  /* Pointer to palette */
 ,GUI_DRAW_RLE8
};
