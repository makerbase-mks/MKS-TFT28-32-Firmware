...
static GUI_CONST_STORAGE GUI_COLOR Colorsbmp_step_move[] = {
...
static GUI_CONST_STORAGE GUI_LOGPALETTE Palbmp_step_move = {
  256,	/* number of entries */
  0, 	/* No transparency */
  &Colorsbmp_step_move[0]
};

static GUI_CONST_STORAGE unsigned char acbmp_step_move[] = {
  /* RLE: 291 Pixels @ 000,000*/ 254, 0xE0, 37, 0xE0, 
  /* RLE: 001 Pixels @ 051,003*/ 1, 0xE1, 
  /* RLE: 077 Pixels @ 052,003*/ 77, 0xE0, 
  /* ABS: 003 Pixels @ 049,004*/ 0, 3, 0xFF, 0xFF, 0xFE, 
  /* RLE: 077 Pixels @ 052,004*/ 77, 0xE0, 
  /* ABS: 003 Pixels @ 049,005*/ 0, 3, 0xFF, 0xEA, 0xFE, 
  /* RLE: 078 Pixels @ 052,005*/ 78, 0xE0, 
  /* ABS: 002 Pixels @ 050,006*/ 0, 2, 0xE9, 0xFE, 
  /* RLE: 078 Pixels @ 052,006*/ 78, 0xE0, 
  /* ABS: 002 Pixels @ 050,007*/ 0, 2, 0xE9, 0xFE, 
  /* RLE: 078 Pixels @ 052,007*/ 78, 0xE0, 
  /* ABS: 002 Pixels @ 050,008*/ 0, 2, 0xE9, 0xFE, 
  /* RLE: 068 Pixels @ 052,008*/ 68, 0xE0, 
  /* ABS: 003 Pixels @ 040,009*/ 0, 3, 0xC0, 0xFF, 0xFF, 
  /* RLE: 007 Pixels @ 043,009*/ 7, 0xE0, 
  /* ABS: 002 Pixels @ 050,009*/ 0, 2, 0xE9, 0xFE, 
  /* RLE: 068 Pixels @ 052,009*/ 68, 0xE0, 
  /* RLE: 001 Pixels @ 040,010*/ 1, 0xC0, 
  /* RLE: 004 Pixels @ 041,010*/ 4, 0xFF, 
  /* RLE: 005 Pixels @ 045,010*/ 5, 0xE0, 
  /* ABS: 002 Pixels @ 050,010*/ 0, 2, 0xE9, 0xFE, 
  /* RLE: 065 Pixels @ 052,010*/ 65, 0xE0, 
  /* ABS: 002 Pixels @ 037,011*/ 0, 2, 0xC0, 0xE0, 
  /* RLE: 007 Pixels @ 039,011*/ 7, 0xFF, 
  /* RLE: 003 Pixels @ 046,011*/ 3, 0xE0, 
  /* RLE: 005 Pixels @ 049,011*/ 5, 0xFF, 
  /* RLE: 061 Pixels @ 054,011*/ 61, 0xE0, 
  /* RLE: 001 Pixels @ 035,012*/ 1, 0xC0, 
  /* RLE: 012 Pixels @ 036,012*/ 12, 0xFF, 
  /* RLE: 001 Pixels @ 048,012*/ 1, 0xE0, 
  /* RLE: 004 Pixels @ 049,012*/ 4, 0xE9, 
  /* RLE: 001 Pixels @ 053,012*/ 1, 0xE1, 
  /* RLE: 061 Pixels @ 054,012*/ 61, 0xE0, 
  ...
  /* RLE: 046 Pixels @ 060,022*/ 46, 0xE0, 
  /* ABS: 007 Pixels @ 026,023*/ 0, 7, 0xE1, 0xE0, 0xE0, 0xFF, 0xFF, 0xFF, 0xC0, 
  /* RLE: 023 Pixels @ 033,023*/ 23, 0xE0, 
  /* RLE: 003 Pixels @ 056,023*/ 3, 0xFF, 
  /* RLE: 036 Pixels @ 059,023*/ 36, 0xE0, 
  /* RLE: 004 Pixels @ 015,024*/ 4, 0xFF, 
  /* RLE: 001 Pixels @ 019,024*/ 1, 0xE1, 
  /* RLE: 004 Pixels @ 020,024*/ 4, 0xE0, 
  /* RLE: 003 Pixels @ 024,024*/ 3, 0xFF, 
  /* ABS: 004 Pixels @ 027,024*/ 0, 4, 0xE0, 0xE0, 0xFF, 0xFF, 
  /* RLE: 025 Pixels @ 031,024*/ 25, 0xE0, 
  /* RLE: 003 Pixels @ 056,024*/ 3, 0xFF, 
  /* RLE: 035 Pixels @ 059,024*/ 35, 0xE0, 
  /* ABS: 006 Pixels @ 014,025*/ 0, 6, 0xE1, 0xFF, 0xE0, 0xE0, 0xFF, 0xFF, 
  /* RLE: 004 Pixels @ 020,025*/ 4, 0xE0, 
  /* ABS: 007 Pixels @ 024,025*/ 0, 7, 0xEB, 0xF4, 0xFF, 0xE0, 0xE0, 0xE0, 0xC0, 
  /* RLE: 025 Pixels @ 031,025*/ 25, 0xE0, 
  /* RLE: 003 Pixels @ 056,025*/ 3, 0xFF, 
  /* RLE: 035 Pixels @ 059,025*/ 35, 0xE0, 
  /* ABS: 006 Pixels @ 014,026*/ 0, 6, 0xFF, 0xF5, 0xE0, 0xE0, 0xFF, 0xFE, 
  /* RLE: 005 Pixels @ 020,026*/ 5, 0xE0, 
  /* ABS: 002 Pixels @ 025,026*/ 0, 2, 0xEB, 0xFF, 
  /* RLE: 029 Pixels @ 027,026*/ 29, 0xE0, 
  /* RLE: 003 Pixels @ 056,026*/ 3, 0xFF, 
  /* RLE: 035 Pixels @ 059,026*/ 35, 0xE0, 
  /* ABS: 006 Pixels @ 014,027*/ 0, 6, 0xFF, 0xFF, 0xE0, 0xE0, 0xE0, 0xFE, 
  /* RLE: 005 Pixels @ 020,027*/ 5, 0xE0, 
  /* ABS: 002 Pixels @ 025,027*/ 0, 2, 0xEB, 0xFF, 
  /* RLE: 029 Pixels @ 027,027*/ 29, 0xE0, 
  /* RLE: 003 Pixels @ 056,027*/ 3, 0xFF, 
  /* RLE: 035 Pixels @ 059,027*/ 35, 0xE0, 
  /* ABS: 006 Pixels @ 014,028*/ 0, 6, 0xFF, 0xFF, 0xE0, 0xE0, 0xE0, 0xFE, 
  /* RLE: 005 Pixels @ 020,028*/ 5, 0xE0, 
  /* ABS: 002 Pixels @ 025,028*/ 0, 2, 0xEB, 0xFF, 
  /* RLE: 004 Pixels @ 027,028*/ 4, 0xE0, 
  /* RLE: 001 Pixels @ 031,028*/ 1, 0xC0, 
  /* RLE: 021 Pixels @ 032,028*/ 21, 0xE0, 
  /* RLE: 006 Pixels @ 053,028*/ 6, 0xFF, 
  /* RLE: 035 Pixels @ 059,028*/ 35, 0xE0, 
  /* ABS: 006 Pixels @ 014,029*/ 0, 6, 0xFF, 0xFF, 0xE0, 0xE0, 0xE9, 0xFE, 
  /* RLE: 005 Pixels @ 020,029*/ 5, 0xE0, 
  /* ABS: 009 Pixels @ 025,029*/ 0, 9, 0xEB, 0xFF, 0xE0, 0xE0, 0xE0, 0xFF, 0xFF, 0xE0, 0xC0, 
  /* RLE: 019 Pixels @ 034,029*/ 19, 0xE0, 
  /* RLE: 006 Pixels @ 053,029*/ 6, 0xFF, 
  /* RLE: 035 Pixels @ 059,029*/ 35, 0xE0, 
  /* ABS: 006 Pixels @ 014,030*/ 0, 6, 0xE1, 0xFF, 0xE0, 0xE0, 0xFF, 0xFF, 
  /* RLE: 005 Pixels @ 020,030*/ 5, 0xE0, 
  /* ABS: 005 Pixels @ 025,030*/ 0, 5, 0xEB, 0xFF, 0xE0, 0xE0, 0xE0, 
  /* RLE: 004 Pixels @ 030,030*/ 4, 0xFF, 
  /* RLE: 019 Pixels @ 034,030*/ 19, 0xE0, 
  /* RLE: 007 Pixels @ 053,030*/ 7, 0xFF, 
  /* RLE: 035 Pixels @ 060,030*/ 35, 0xE0, 
  /* RLE: 003 Pixels @ 015,031*/ 3, 0xFF, 
  /* ABS: 012 Pixels @ 018,031*/ 0, 12, 0xF5, 0xE1, 0xE0, 0xFF, 0xE1, 0xE1, 0xFF, 0xFE, 0xFE, 0xFF, 0xFF, 0xE0, 
  /* RLE: 006 Pixels @ 030,031*/ 6, 0xFF, 
  /* RLE: 017 Pixels @ 036,031*/ 17, 0xE0, 
  /* RLE: 007 Pixels @ 053,031*/ 7, 0xFF, 
  /* RLE: 041 Pixels @ 060,031*/ 41, 0xE0, 
  /* ABS: 003 Pixels @ 021,032*/ 0, 3, 0xE9, 0xE0, 0xE0, 
  /* RLE: 004 Pixels @ 024,032*/ 4, 0xE9, 
  /* ABS: 002 Pixels @ 028,032*/ 0, 2, 0xE0, 0xE0, 
  ...
  0};  /* 639 for 4000 pixels */

GUI_CONST_STORAGE GUI_BITMAP bmbmp_step_move = {
  80, /* XSize */
  50, /* YSize */
  80, /* BytesPerLine */
  GUI_COMPRESS_RLE8, /* BitsPerPixel */
  acbmp_step_move,  /* Pointer to picture data (indices) */
  &Palbmp_step_move  /* Pointer to palette */
 ,GUI_DRAW_RLE8
};
