...
static GUI_CONST_STORAGE GUI_COLOR Colorsbmp_en_sel[] = {
...
static GUI_CONST_STORAGE GUI_LOGPALETTE Palbmp_en_sel = {
  256,	/* number of entries */
  0, 	/* No transparency */
  &Colorsbmp_en_sel[0]
};

static GUI_CONST_STORAGE unsigned char acbmp_en_sel[] = {
  /* RLE: 1065 Pixels @ 000,000*/ 254, 0x10, 254, 0x10, 254, 0x10, 254, 0x10, 49, 0x10, 
  /* RLE: 012 Pixels @ 025,013*/ 12, 0xFF, 
  /* ABS: 002 Pixels @ 037,013*/ 0, 2, 0x10, 0x10, 
  /* RLE: 005 Pixels @ 039,013*/ 5, 0xFF, 
  /* RLE: 005 Pixels @ 044,013*/ 5, 0x10, 
  /* RLE: 004 Pixels @ 049,013*/ 4, 0xFF, 
  /* RLE: 052 Pixels @ 053,013*/ 52, 0x10, 
  /* RLE: 012 Pixels @ 025,014*/ 12, 0xFF, 
  /* ABS: 002 Pixels @ 037,014*/ 0, 2, 0x10, 0x10, 
  /* RLE: 005 Pixels @ 039,014*/ 5, 0xFF, 
  /* RLE: 005 Pixels @ 044,014*/ 5, 0x10, 
  /* RLE: 004 Pixels @ 049,014*/ 4, 0xFF, 
  /* RLE: 052 Pixels @ 053,014*/ 52, 0x10, 
  /* RLE: 012 Pixels @ 025,015*/ 12, 0xFF, 
  /* ABS: 002 Pixels @ 037,015*/ 0, 2, 0x10, 0x10, 
  /* RLE: 005 Pixels @ 039,015*/ 5, 0xFF, 
  /* RLE: 005 Pixels @ 044,015*/ 5, 0x10, 
  /* RLE: 004 Pixels @ 049,015*/ 4, 0xFF, 
  /* RLE: 052 Pixels @ 053,015*/ 52, 0x10, 
  /* RLE: 012 Pixels @ 025,016*/ 12, 0xFF, 
  /* ABS: 002 Pixels @ 037,016*/ 0, 2, 0x10, 0x10, 
  /* RLE: 006 Pixels @ 039,016*/ 6, 0xFF, 
  /* RLE: 004 Pixels @ 045,016*/ 4, 0x10, 
  /* RLE: 004 Pixels @ 049,016*/ 4, 0xFF, 
  /* RLE: 052 Pixels @ 053,016*/ 52, 0x10, 
  /* RLE: 012 Pixels @ 025,017*/ 12, 0xFF, 
  /* ABS: 002 Pixels @ 037,017*/ 0, 2, 0x10, 0x10, 
  /* RLE: 006 Pixels @ 039,017*/ 6, 0xFF, 
  /* RLE: 004 Pixels @ 045,017*/ 4, 0x10, 
  /* RLE: 004 Pixels @ 049,017*/ 4, 0xFF, 
  /* RLE: 052 Pixels @ 053,017*/ 52, 0x10, 
  /* RLE: 005 Pixels @ 025,018*/ 5, 0xFF, 
  /* RLE: 009 Pixels @ 030,018*/ 9, 0x10, 
  /* RLE: 007 Pixels @ 039,018*/ 7, 0xFF, 
  /* RLE: 003 Pixels @ 046,018*/ 3, 0x10, 
  /* RLE: 004 Pixels @ 049,018*/ 4, 0xFF, 
  /* RLE: 052 Pixels @ 053,018*/ 52, 0x10, 
  /* RLE: 005 Pixels @ 025,019*/ 5, 0xFF, 
  /* RLE: 009 Pixels @ 030,019*/ 9, 0x10, 
  /* RLE: 007 Pixels @ 039,019*/ 7, 0xFF, 
  /* RLE: 003 Pixels @ 046,019*/ 3, 0x10, 
  /* RLE: 004 Pixels @ 049,019*/ 4, 0xFF, 
  /* RLE: 052 Pixels @ 053,019*/ 52, 0x10, 
  /* RLE: 005 Pixels @ 025,020*/ 5, 0xFF, 
  /* RLE: 009 Pixels @ 030,020*/ 9, 0x10, 
  /* RLE: 008 Pixels @ 039,020*/ 8, 0xFF, 
  /* ABS: 002 Pixels @ 047,020*/ 0, 2, 0x10, 0x10, 
  /* RLE: 004 Pixels @ 049,020*/ 4, 0xFF, 
  /* RLE: 052 Pixels @ 053,020*/ 52, 0x10, 
  /* RLE: 005 Pixels @ 025,021*/ 5, 0xFF, 
  /* RLE: 009 Pixels @ 030,021*/ 9, 0x10, 
  /* RLE: 008 Pixels @ 039,021*/ 8, 0xFF, 
  /* ABS: 002 Pixels @ 047,021*/ 0, 2, 0x10, 0x10, 
  /* RLE: 004 Pixels @ 049,021*/ 4, 0xFF, 
  /* RLE: 052 Pixels @ 053,021*/ 52, 0x10, 
  /* RLE: 011 Pixels @ 025,022*/ 11, 0xFF, 
  /* RLE: 003 Pixels @ 036,022*/ 3, 0x10, 
  /* RLE: 009 Pixels @ 039,022*/ 9, 0xFF, 
  /* RLE: 001 Pixels @ 048,022*/ 1, 0x10, 
  /* RLE: 004 Pixels @ 049,022*/ 4, 0xFF, 
  /* RLE: 052 Pixels @ 053,022*/ 52, 0x10, 
  /* RLE: 011 Pixels @ 025,023*/ 11, 0xFF, 
  /* RLE: 003 Pixels @ 036,023*/ 3, 0x10, 
  /* RLE: 009 Pixels @ 039,023*/ 9, 0xFF, 
  /* RLE: 001 Pixels @ 048,023*/ 1, 0x10, 
  /* RLE: 004 Pixels @ 049,023*/ 4, 0xFF, 
  /* RLE: 052 Pixels @ 053,023*/ 52, 0x10, 
  /* RLE: 011 Pixels @ 025,024*/ 11, 0xFF, 
  /* RLE: 003 Pixels @ 036,024*/ 3, 0x10, 
  /* RLE: 004 Pixels @ 039,024*/ 4, 0xFF, 
  /* RLE: 001 Pixels @ 043,024*/ 1, 0x10, 
  /* RLE: 009 Pixels @ 044,024*/ 9, 0xFF, 
  /* RLE: 052 Pixels @ 053,024*/ 52, 0x10, 
  /* RLE: 011 Pixels @ 025,025*/ 11, 0xFF, 
  /* RLE: 003 Pixels @ 036,025*/ 3, 0x10, 
  /* RLE: 004 Pixels @ 039,025*/ 4, 0xFF, 
  /* ABS: 002 Pixels @ 043,025*/ 0, 2, 0x10, 0x10, 
  /* RLE: 008 Pixels @ 045,025*/ 8, 0xFF, 
  /* RLE: 052 Pixels @ 053,025*/ 52, 0x10, 
  /* RLE: 005 Pixels @ 025,026*/ 5, 0xFF, 
  /* RLE: 009 Pixels @ 030,026*/ 9, 0x10, 
  /* RLE: 004 Pixels @ 039,026*/ 4, 0xFF, 
  /* ABS: 002 Pixels @ 043,026*/ 0, 2, 0x10, 0x10, 
  /* RLE: 008 Pixels @ 045,026*/ 8, 0xFF, 
  /* RLE: 052 Pixels @ 053,026*/ 52, 0x10, 
  /* RLE: 005 Pixels @ 025,027*/ 5, 0xFF, 
  /* RLE: 009 Pixels @ 030,027*/ 9, 0x10, 
  /* RLE: 004 Pixels @ 039,027*/ 4, 0xFF, 
  /* RLE: 003 Pixels @ 043,027*/ 3, 0x10, 
  /* RLE: 007 Pixels @ 046,027*/ 7, 0xFF, 
  /* RLE: 052 Pixels @ 053,027*/ 52, 0x10, 
  /* RLE: 005 Pixels @ 025,028*/ 5, 0xFF, 
  /* RLE: 009 Pixels @ 030,028*/ 9, 0x10, 
  /* RLE: 004 Pixels @ 039,028*/ 4, 0xFF, 
  /* RLE: 003 Pixels @ 043,028*/ 3, 0x10, 
  /* RLE: 007 Pixels @ 046,028*/ 7, 0xFF, 
  /* RLE: 052 Pixels @ 053,028*/ 52, 0x10, 
  /* RLE: 005 Pixels @ 025,029*/ 5, 0xFF, 
  /* RLE: 009 Pixels @ 030,029*/ 9, 0x10, 
  /* RLE: 004 Pixels @ 039,029*/ 4, 0xFF, 
  /* RLE: 003 Pixels @ 043,029*/ 3, 0x10, 
  /* RLE: 007 Pixels @ 046,029*/ 7, 0xFF, 
  /* RLE: 052 Pixels @ 053,029*/ 52, 0x10, 
  /* RLE: 012 Pixels @ 025,030*/ 12, 0xFF, 
  /* ABS: 002 Pixels @ 037,030*/ 0, 2, 0x10, 0x10, 
  /* RLE: 004 Pixels @ 039,030*/ 4, 0xFF, 
  /* RLE: 004 Pixels @ 043,030*/ 4, 0x10, 
  /* RLE: 006 Pixels @ 047,030*/ 6, 0xFF, 
  /* RLE: 052 Pixels @ 053,030*/ 52, 0x10, 
  /* RLE: 012 Pixels @ 025,031*/ 12, 0xFF, 
  /* ABS: 002 Pixels @ 037,031*/ 0, 2, 0x10, 0x10, 
  /* RLE: 004 Pixels @ 039,031*/ 4, 0xFF, 
  /* RLE: 004 Pixels @ 043,031*/ 4, 0x10, 
  /* RLE: 006 Pixels @ 047,031*/ 6, 0xFF, 
  /* RLE: 052 Pixels @ 053,031*/ 52, 0x10, 
  /* RLE: 012 Pixels @ 025,032*/ 12, 0xFF, 
  /* ABS: 002 Pixels @ 037,032*/ 0, 2, 0x10, 0x10, 
  /* RLE: 004 Pixels @ 039,032*/ 4, 0xFF, 
  /* RLE: 005 Pixels @ 043,032*/ 5, 0x10, 
  /* RLE: 005 Pixels @ 048,032*/ 5, 0xFF, 
  /* RLE: 052 Pixels @ 053,032*/ 52, 0x10, 
  /* RLE: 012 Pixels @ 025,033*/ 12, 0xFF, 
  /* ABS: 002 Pixels @ 037,033*/ 0, 2, 0x10, 0x10, 
  /* RLE: 004 Pixels @ 039,033*/ 4, 0xFF, 
  /* RLE: 005 Pixels @ 043,033*/ 5, 0x10, 
  /* RLE: 005 Pixels @ 048,033*/ 5, 0xFF, 
  /* RLE: 1307 Pixels @ 053,033*/ 254, 0x10, 254, 0x10, 254, 0x10, 254, 0x10, 254, 0x10, 37, 0x10, 


  0};  /* 298 for 4000 pixels */

GUI_CONST_STORAGE GUI_BITMAP bmbmp_en_sel = {
  80, /* XSize */
  50, /* YSize */
  80, /* BytesPerLine */
  GUI_COMPRESS_RLE8, /* BitsPerPixel */
  acbmp_en_sel,  /* Pointer to picture data (indices) */
  &Palbmp_en_sel  /* Pointer to palette */
 ,GUI_DRAW_RLE8
};
