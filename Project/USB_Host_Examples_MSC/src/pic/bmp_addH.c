...
static GUI_CONST_STORAGE GUI_COLOR Colorsbmp_addH[] = {
...
static GUI_CONST_STORAGE GUI_LOGPALETTE Palbmp_addH = {
  256,	/* number of entries */
  0, 	/* No transparency */
  &Colorsbmp_addH[0]
};

static GUI_CONST_STORAGE unsigned char acbmp_addH[] = {
  /* RLE: 279 Pixels @ 000,000*/ 254, 0xE0, 25, 0xE0, 
  /* ABS: 002 Pixels @ 039,003*/ 0, 2, 0xEA, 0xEA, 
  /* RLE: 076 Pixels @ 041,003*/ 76, 0xE0, 
  /* ABS: 006 Pixels @ 037,004*/ 0, 6, 0xE1, 0xF4, 0xFF, 0xFF, 0xF5, 0xE9, 
  /* RLE: 072 Pixels @ 043,004*/ 72, 0xE0, 
  /* ABS: 002 Pixels @ 035,005*/ 0, 2, 0xE1, 0xF4, 
  /* RLE: 006 Pixels @ 037,005*/ 6, 0xFF, 
  /* ABS: 002 Pixels @ 043,005*/ 0, 2, 0xF4, 0xE1, 
  /* RLE: 069 Pixels @ 045,005*/ 69, 0xE0, 
  /* ABS: 002 Pixels @ 034,006*/ 0, 2, 0xEB, 0xFE, 
  /* RLE: 008 Pixels @ 036,006*/ 8, 0xFF, 
  /* ABS: 002 Pixels @ 044,006*/ 0, 2, 0xFE, 0xEB, 
  /* RLE: 066 Pixels @ 046,006*/ 66, 0xE0, 
  /* ABS: 002 Pixels @ 032,007*/ 0, 2, 0xEA, 0xF6, 
  /* RLE: 012 Pixels @ 034,007*/ 12, 0xFF, 
  /* ABS: 002 Pixels @ 046,007*/ 0, 2, 0xF6, 0xEA, 
  /* RLE: 062 Pixels @ 048,007*/ 62, 0xE0, 
  /* ABS: 002 Pixels @ 030,008*/ 0, 2, 0xE9, 0xF5, 
  /* RLE: 016 Pixels @ 032,008*/ 16, 0xFF, 
  /* ABS: 002 Pixels @ 048,008*/ 0, 2, 0xF5, 0xEA, 
  /* RLE: 058 Pixels @ 050,008*/ 58, 0xE0, 
  /* ABS: 002 Pixels @ 028,009*/ 0, 2, 0xE1, 0xF4, 
  /* RLE: 020 Pixels @ 030,009*/ 20, 0xFF, 
  /* ABS: 002 Pixels @ 050,009*/ 0, 2, 0xF5, 0xE9, 
  /* RLE: 055 Pixels @ 052,009*/ 55, 0xE0, 
  /* ABS: 002 Pixels @ 027,010*/ 0, 2, 0xEB, 0xFE, 
  /* RLE: 023 Pixels @ 029,010*/ 23, 0xFF, 
  /* ABS: 002 Pixels @ 052,010*/ 0, 2, 0xF4, 0xE1, 
  /* RLE: 051 Pixels @ 054,010*/ 51, 0xE0, 
  /* ABS: 002 Pixels @ 025,011*/ 0, 2, 0xEB, 0xFE, 
  /* RLE: 026 Pixels @ 027,011*/ 26, 0xFF, 
  /* ABS: 002 Pixels @ 053,011*/ 0, 2, 0xFE, 0xEB, 
  /* RLE: 049 Pixels @ 055,011*/ 49, 0xE0, 
  /* RLE: 001 Pixels @ 024,012*/ 1, 0xE1, 
  /* RLE: 007 Pixels @ 025,012*/ 7, 0xF5, 
  /* RLE: 016 Pixels @ 032,012*/ 16, 0xFF, 
  /* RLE: 007 Pixels @ 048,012*/ 7, 0xF5, 
  /* RLE: 001 Pixels @ 055,012*/ 1, 0xE9, 
  /* RLE: 056 Pixels @ 056,012*/ 56, 0xE0, 
  /* RLE: 016 Pixels @ 032,013*/ 16, 0xFF, 
  /* RLE: 064 Pixels @ 048,013*/ 64, 0xE0, 
  /* RLE: 016 Pixels @ 032,014*/ 16, 0xFF, 
  /* RLE: 001 Pixels @ 048,014*/ 1, 0xE1, 
  /* RLE: 063 Pixels @ 049,014*/ 63, 0xE0, 
  /* RLE: 016 Pixels @ 032,015*/ 16, 0xFF, 
  /* RLE: 001 Pixels @ 048,015*/ 1, 0xE1, 
  /* RLE: 063 Pixels @ 049,015*/ 63, 0xE0, 
  /* RLE: 016 Pixels @ 032,016*/ 16, 0xFF, 
  /* RLE: 001 Pixels @ 048,016*/ 1, 0xE1, 
  /* RLE: 063 Pixels @ 049,016*/ 63, 0xE0, 
  /* RLE: 016 Pixels @ 032,017*/ 16, 0xFF, 
  /* RLE: 001 Pixels @ 048,017*/ 1, 0xE1, 
  /* RLE: 063 Pixels @ 049,017*/ 63, 0xE0, 
  /* RLE: 016 Pixels @ 032,018*/ 16, 0xFF, 
  /* RLE: 001 Pixels @ 048,018*/ 1, 0xE1, 
  /* RLE: 063 Pixels @ 049,018*/ 63, 0xE0, 
  /* RLE: 016 Pixels @ 032,019*/ 16, 0xFF, 
  /* RLE: 001 Pixels @ 048,019*/ 1, 0xE1, 
  /* RLE: 063 Pixels @ 049,019*/ 63, 0xE0, 
  /* RLE: 016 Pixels @ 032,020*/ 16, 0xEA, 
  /* RLE: 352 Pixels @ 048,020*/ 254, 0xE0, 98, 0xE0, 


  0};  /* 162 for 2000 pixels */

GUI_CONST_STORAGE GUI_BITMAP bmbmp_addH = {
  80, /* XSize */
  25, /* YSize */
  80, /* BytesPerLine */
  GUI_COMPRESS_RLE8, /* BitsPerPixel */
  acbmp_addH,  /* Pointer to picture data (indices) */
  &Palbmp_addH  /* Pointer to palette */
 ,GUI_DRAW_RLE8
};
