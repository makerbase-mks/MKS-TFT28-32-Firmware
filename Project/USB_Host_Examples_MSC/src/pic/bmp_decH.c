...
static GUI_CONST_STORAGE GUI_COLOR Colorsbmp_decH[] = {
...
static GUI_CONST_STORAGE GUI_LOGPALETTE Palbmp_decH = {
  256,	/* number of entries */
  0, 	/* No transparency */
  &Colorsbmp_decH[0]
};

static GUI_CONST_STORAGE unsigned char acbmp_decH[] = {
  /* RLE: 272 Pixels @ 000,000*/ 254, 0xE0, 18, 0xE0, 
  /* RLE: 016 Pixels @ 032,003*/ 16, 0xEA, 
  /* RLE: 064 Pixels @ 048,003*/ 64, 0xE0, 
  /* RLE: 016 Pixels @ 032,004*/ 16, 0xFF, 
  /* RLE: 001 Pixels @ 048,004*/ 1, 0xE1, 
  /* RLE: 063 Pixels @ 049,004*/ 63, 0xE0, 
  /* RLE: 016 Pixels @ 032,005*/ 16, 0xFF, 
  /* RLE: 001 Pixels @ 048,005*/ 1, 0xE1, 
  /* RLE: 063 Pixels @ 049,005*/ 63, 0xE0, 
  /* RLE: 016 Pixels @ 032,006*/ 16, 0xFF, 
  /* RLE: 001 Pixels @ 048,006*/ 1, 0xE1, 
  /* RLE: 063 Pixels @ 049,006*/ 63, 0xE0, 
  /* RLE: 016 Pixels @ 032,007*/ 16, 0xFF, 
  /* RLE: 001 Pixels @ 048,007*/ 1, 0xE1, 
  /* RLE: 063 Pixels @ 049,007*/ 63, 0xE0, 
  /* RLE: 016 Pixels @ 032,008*/ 16, 0xFF, 
  /* RLE: 001 Pixels @ 048,008*/ 1, 0xE1, 
  /* RLE: 063 Pixels @ 049,008*/ 63, 0xE0, 
  /* RLE: 016 Pixels @ 032,009*/ 16, 0xFF, 
  /* RLE: 001 Pixels @ 048,009*/ 1, 0xE1, 
  /* RLE: 063 Pixels @ 049,009*/ 63, 0xE0, 
  /* RLE: 016 Pixels @ 032,010*/ 16, 0xFF, 
  /* RLE: 056 Pixels @ 048,010*/ 56, 0xE0, 
  /* RLE: 001 Pixels @ 024,011*/ 1, 0xE1, 
  /* RLE: 007 Pixels @ 025,011*/ 7, 0xF5, 
  /* RLE: 016 Pixels @ 032,011*/ 16, 0xFF, 
  /* RLE: 007 Pixels @ 048,011*/ 7, 0xF5, 
  /* RLE: 001 Pixels @ 055,011*/ 1, 0xE9, 
  /* RLE: 049 Pixels @ 056,011*/ 49, 0xE0, 
  /* ABS: 002 Pixels @ 025,012*/ 0, 2, 0xEB, 0xFE, 
  /* RLE: 026 Pixels @ 027,012*/ 26, 0xFF, 
  /* ABS: 002 Pixels @ 053,012*/ 0, 2, 0xFE, 0xEB, 
  /* RLE: 052 Pixels @ 055,012*/ 52, 0xE0, 
  /* ABS: 002 Pixels @ 027,013*/ 0, 2, 0xEB, 0xFE, 
  /* RLE: 023 Pixels @ 029,013*/ 23, 0xFF, 
  /* ABS: 002 Pixels @ 052,013*/ 0, 2, 0xF4, 0xE1, 
  /* RLE: 054 Pixels @ 054,013*/ 54, 0xE0, 
  /* ABS: 002 Pixels @ 028,014*/ 0, 2, 0xE1, 0xF4, 
  /* RLE: 020 Pixels @ 030,014*/ 20, 0xFF, 
  /* ABS: 002 Pixels @ 050,014*/ 0, 2, 0xF5, 0xE9, 
  /* RLE: 058 Pixels @ 052,014*/ 58, 0xE0, 
  /* ABS: 002 Pixels @ 030,015*/ 0, 2, 0xE9, 0xF5, 
  /* RLE: 016 Pixels @ 032,015*/ 16, 0xFF, 
  /* ABS: 002 Pixels @ 048,015*/ 0, 2, 0xF5, 0xEA, 
  /* RLE: 062 Pixels @ 050,015*/ 62, 0xE0, 
  /* ABS: 002 Pixels @ 032,016*/ 0, 2, 0xEA, 0xF6, 
  /* RLE: 012 Pixels @ 034,016*/ 12, 0xFF, 
  /* ABS: 002 Pixels @ 046,016*/ 0, 2, 0xF6, 0xEA, 
  /* RLE: 066 Pixels @ 048,016*/ 66, 0xE0, 
  /* ABS: 002 Pixels @ 034,017*/ 0, 2, 0xEB, 0xFE, 
  /* RLE: 008 Pixels @ 036,017*/ 8, 0xFF, 
  /* ABS: 002 Pixels @ 044,017*/ 0, 2, 0xFE, 0xEB, 
  /* RLE: 069 Pixels @ 046,017*/ 69, 0xE0, 
  /* ABS: 002 Pixels @ 035,018*/ 0, 2, 0xE1, 0xF4, 
  /* RLE: 006 Pixels @ 037,018*/ 6, 0xFF, 
  /* ABS: 002 Pixels @ 043,018*/ 0, 2, 0xF4, 0xE1, 
  /* RLE: 072 Pixels @ 045,018*/ 72, 0xE0, 
  /* ABS: 006 Pixels @ 037,019*/ 0, 6, 0xE1, 0xF4, 0xFF, 0xFF, 0xF5, 0xE9, 
  /* RLE: 076 Pixels @ 043,019*/ 76, 0xE0, 
  /* ABS: 002 Pixels @ 039,020*/ 0, 2, 0xEA, 0xEA, 
  /* RLE: 359 Pixels @ 041,020*/ 254, 0xE0, 105, 0xE0, 


  0};  /* 162 for 2000 pixels */

GUI_CONST_STORAGE GUI_BITMAP bmbmp_decH = {
  80, /* XSize */
  25, /* YSize */
  80, /* BytesPerLine */
  GUI_COMPRESS_RLE8, /* BitsPerPixel */
  acbmp_decH,  /* Pointer to picture data (indices) */
  &Palbmp_decH  /* Pointer to palette */
 ,GUI_DRAW_RLE8
};
