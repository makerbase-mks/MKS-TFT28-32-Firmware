...
static GUI_CONST_STORAGE GUI_COLOR Colorsbmp_stop[] = {
...
static GUI_CONST_STORAGE GUI_LOGPALETTE Palbmp_stop = {
  256,	/* number of entries */
  0, 	/* No transparency */
  &Colorsbmp_stop[0]
};

static GUI_CONST_STORAGE unsigned char acbmp_stop[] = {
  /* RLE: 1147 Pixels @ 000,000*/ 254, 0xE0, 254, 0xE0, 254, 0xE0, 254, 0xE0, 131, 0xE0, 
  /* RLE: 025 Pixels @ 027,014*/ 25, 0xFF, 
  /* RLE: 055 Pixels @ 052,014*/ 55, 0xE0, 
  /* RLE: 025 Pixels @ 027,015*/ 25, 0xFF, 
  /* RLE: 055 Pixels @ 052,015*/ 55, 0xE0, 
  /* RLE: 025 Pixels @ 027,016*/ 25, 0xFF, 
  /* RLE: 055 Pixels @ 052,016*/ 55, 0xE0, 
  /* RLE: 025 Pixels @ 027,017*/ 25, 0xFF, 
  /* RLE: 055 Pixels @ 052,017*/ 55, 0xE0, 
  /* RLE: 025 Pixels @ 027,018*/ 25, 0xFF, 
  /* RLE: 055 Pixels @ 052,018*/ 55, 0xE0, 
  /* RLE: 025 Pixels @ 027,019*/ 25, 0xFF, 
  /* RLE: 055 Pixels @ 052,019*/ 55, 0xE0, 
  /* RLE: 025 Pixels @ 027,020*/ 25, 0xFF, 
  /* RLE: 055 Pixels @ 052,020*/ 55, 0xE0, 
  /* RLE: 025 Pixels @ 027,021*/ 25, 0xFF, 
  /* RLE: 055 Pixels @ 052,021*/ 55, 0xE0, 
  /* RLE: 025 Pixels @ 027,022*/ 25, 0xFF, 
  /* RLE: 055 Pixels @ 052,022*/ 55, 0xE0, 
  /* RLE: 025 Pixels @ 027,023*/ 25, 0xFF, 
  /* RLE: 055 Pixels @ 052,023*/ 55, 0xE0, 
  /* RLE: 025 Pixels @ 027,024*/ 25, 0xFF, 
  /* RLE: 055 Pixels @ 052,024*/ 55, 0xE0, 
  /* RLE: 025 Pixels @ 027,025*/ 25, 0xFF, 
  /* RLE: 055 Pixels @ 052,025*/ 55, 0xE0, 
  /* RLE: 025 Pixels @ 027,026*/ 25, 0xFF, 
  /* RLE: 055 Pixels @ 052,026*/ 55, 0xE0, 
  /* RLE: 025 Pixels @ 027,027*/ 25, 0xFF, 
  /* RLE: 055 Pixels @ 052,027*/ 55, 0xE0, 
  /* RLE: 025 Pixels @ 027,028*/ 25, 0xFF, 
  /* RLE: 055 Pixels @ 052,028*/ 55, 0xE0, 
  /* RLE: 025 Pixels @ 027,029*/ 25, 0xFF, 
  /* RLE: 055 Pixels @ 052,029*/ 55, 0xE0, 
  /* RLE: 025 Pixels @ 027,030*/ 25, 0xFF, 
  /* RLE: 055 Pixels @ 052,030*/ 55, 0xE0, 
  /* RLE: 025 Pixels @ 027,031*/ 25, 0xFF, 
  /* RLE: 055 Pixels @ 052,031*/ 55, 0xE0, 
  /* RLE: 025 Pixels @ 027,032*/ 25, 0xFF, 
  /* RLE: 055 Pixels @ 052,032*/ 55, 0xE0, 
  /* RLE: 025 Pixels @ 027,033*/ 25, 0xFF, 
  /* RLE: 055 Pixels @ 052,033*/ 55, 0xE0, 
  /* RLE: 025 Pixels @ 027,034*/ 25, 0xFF, 
  /* RLE: 055 Pixels @ 052,034*/ 55, 0xE0, 
  /* RLE: 025 Pixels @ 027,035*/ 25, 0xFF, 
  /* RLE: 055 Pixels @ 052,035*/ 55, 0xE0, 
  /* RLE: 025 Pixels @ 027,036*/ 25, 0xFF, 
  /* RLE: 055 Pixels @ 052,036*/ 55, 0xE0, 
  /* RLE: 025 Pixels @ 027,037*/ 25, 0xFF, 
  /* RLE: 055 Pixels @ 052,037*/ 55, 0xE0, 
  /* RLE: 025 Pixels @ 027,038*/ 25, 0xFF, 
  /* RLE: 908 Pixels @ 052,038*/ 254, 0xE0, 254, 0xE0, 254, 0xE0, 146, 0xE0, 


  0};  /* 116 for 4000 pixels */

GUI_CONST_STORAGE GUI_BITMAP bmbmp_stop = {
  80, /* XSize */
  50, /* YSize */
  80, /* BytesPerLine */
  GUI_COMPRESS_RLE8, /* BitsPerPixel */
  acbmp_stop,  /* Pointer to picture data (indices) */
  &Palbmp_stop  /* Pointer to palette */
 ,GUI_DRAW_RLE8
};
