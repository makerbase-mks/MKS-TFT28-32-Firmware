...
static GUI_CONST_STORAGE GUI_COLOR Colorsbmp_speed_extru[] = {
...
static GUI_CONST_STORAGE GUI_LOGPALETTE Palbmp_speed_extru = {
  256,	/* number of entries */
  0, 	/* No transparency */
  &Colorsbmp_speed_extru[0]
};

static GUI_CONST_STORAGE unsigned char acbmp_speed_extru[] = {
  /* RLE: 449 Pixels @ 000,000*/ 254, 0xE0, 195, 0xE0, 
  /* ABS: 007 Pixels @ 049,005*/ 0, 7, 0xFF, 0xFF, 0xE0, 0xE0, 0xE0, 0xFF, 0xFF, 
  /* RLE: 073 Pixels @ 056,005*/ 73, 0xE0, 
  /* RLE: 003 Pixels @ 049,006*/ 3, 0xFF, 
  /* ABS: 004 Pixels @ 052,006*/ 0, 4, 0xE0, 0xE0, 0xFF, 0xFF, 
  /* RLE: 073 Pixels @ 056,006*/ 73, 0xE0, 
  /* RLE: 003 Pixels @ 049,007*/ 3, 0xFF, 
  /* ABS: 004 Pixels @ 052,007*/ 0, 4, 0xE1, 0xE0, 0xFF, 0xFF, 
  /* RLE: 073 Pixels @ 056,007*/ 73, 0xE0, 
  /* RLE: 004 Pixels @ 049,008*/ 4, 0xFF, 
  /* ABS: 003 Pixels @ 053,008*/ 0, 3, 0xE0, 0xFF, 0xFF, 
  /* RLE: 064 Pixels @ 056,008*/ 64, 0xE0, 
  /* ABS: 003 Pixels @ 040,009*/ 0, 3, 0xC0, 0xFF, 0xFF, 
  /* RLE: 006 Pixels @ 043,009*/ 6, 0xE0, 
  /* ABS: 003 Pixels @ 049,009*/ 0, 3, 0xFF, 0xFF, 0xE0, 
  /* RLE: 004 Pixels @ 052,009*/ 4, 0xFF, 
  /* RLE: 064 Pixels @ 056,009*/ 64, 0xE0, 
  /* RLE: 001 Pixels @ 040,010*/ 1, 0xC0, 
  /* RLE: 004 Pixels @ 041,010*/ 4, 0xFF, 
  /* RLE: 004 Pixels @ 045,010*/ 4, 0xE0, 
  /* ABS: 007 Pixels @ 049,010*/ 0, 7, 0xFF, 0xFF, 0xE0, 0xE1, 0xFF, 0xFF, 0xFF, 
  /* RLE: 061 Pixels @ 056,010*/ 61, 0xE0, 
  /* ABS: 002 Pixels @ 037,011*/ 0, 2, 0xC0, 0xE0, 
  /* RLE: 007 Pixels @ 039,011*/ 7, 0xFF, 
  /* RLE: 003 Pixels @ 046,011*/ 3, 0xE0, 
  /* ABS: 007 Pixels @ 049,011*/ 0, 7, 0xFF, 0xFF, 0xE0, 0xE0, 0xFF, 0xFF, 0xFF, 
  /* RLE: 059 Pixels @ 056,011*/ 59, 0xE0, 
  /* RLE: 001 Pixels @ 035,012*/ 1, 0xC0, 
  /* RLE: 012 Pixels @ 036,012*/ 12, 0xFF, 
  /* ABS: 008 Pixels @ 048,012*/ 0, 8, 0xE0, 0xFF, 0xFF, 0xE0, 0xE0, 0xE0, 0xFF, 0xFF, 
  /* RLE: 059 Pixels @ 056,012*/ 59, 0xE0, 
  /* RLE: 013 Pixels @ 035,013*/ 13, 0xFF, 
  /* ABS: 008 Pixels @ 048,013*/ 0, 8, 0xE0, 0xE9, 0xE0, 0xE0, 0xA0, 0xC0, 0xE1, 0xE9, 
  /* RLE: 058 Pixels @ 056,013*/ 58, 0xE0, 
  ...
  /* ABS: 006 Pixels @ 025,025*/ 0, 6, 0xFF, 0xFF, 0xE0, 0xE0, 0xE0, 0xC0, 
  /* RLE: 025 Pixels @ 031,025*/ 25, 0xE0, 
  /* RLE: 003 Pixels @ 056,025*/ 3, 0xFF, 
  /* RLE: 044 Pixels @ 059,025*/ 44, 0xE0, 
  /* RLE: 005 Pixels @ 023,026*/ 5, 0xFF, 
  /* RLE: 028 Pixels @ 028,026*/ 28, 0xE0, 
  /* RLE: 003 Pixels @ 056,026*/ 3, 0xFF, 
  /* RLE: 043 Pixels @ 059,026*/ 43, 0xE0, 
  /* ABS: 002 Pixels @ 022,027*/ 0, 2, 0xFF, 0xFF, 
  /* RLE: 032 Pixels @ 024,027*/ 32, 0xE0, 
  /* RLE: 003 Pixels @ 056,027*/ 3, 0xFF, 
  /* RLE: 043 Pixels @ 059,027*/ 43, 0xE0, 
  /* ABS: 002 Pixels @ 022,028*/ 0, 2, 0xFF, 0xFF, 
  /* RLE: 007 Pixels @ 024,028*/ 7, 0xE0, 
  /* RLE: 001 Pixels @ 031,028*/ 1, 0xC0, 
  /* RLE: 021 Pixels @ 032,028*/ 21, 0xE0, 
  /* RLE: 006 Pixels @ 053,028*/ 6, 0xFF, 
  /* RLE: 044 Pixels @ 059,028*/ 44, 0xE0, 
  /* RLE: 003 Pixels @ 023,029*/ 3, 0xFF, 
  ...
  /* RLE: 003 Pixels @ 024,030*/ 3, 0xFF, 
  /* ABS: 003 Pixels @ 027,030*/ 0, 3, 0xE1, 0xE0, 0xE0, 
  /* RLE: 004 Pixels @ 030,030*/ 4, 0xFF, 
  /* RLE: 019 Pixels @ 034,030*/ 19, 0xE0, 
  /* RLE: 007 Pixels @ 053,030*/ 7, 0xFF, 
  /* RLE: 046 Pixels @ 060,030*/ 46, 0xE0, 
  /* ABS: 004 Pixels @ 026,031*/ 0, 4, 0xFF, 0xFF, 0xE0, 0xE0, 
  /* RLE: 006 Pixels @ 030,031*/ 6, 0xFF, 
  /* RLE: 017 Pixels @ 036,031*/ 17, 0xE0, 
  /* RLE: 007 Pixels @ 053,031*/ 7, 0xFF, 
  /* RLE: 046 Pixels @ 060,031*/ 46, 0xE0, 
  /* ABS: 004 Pixels @ 026,032*/ 0, 4, 0xFF, 0xFF, 0xE0, 0xE0, 
  ...
  /* RLE: 042 Pixels @ 060,032*/ 42, 0xE0, 
  /* RLE: 006 Pixels @ 022,033*/ 6, 0xFF, 
  ...
  /* RLE: 072 Pixels @ 038,035*/ 72, 0xE0, 
  /* ABS: 004 Pixels @ 030,036*/ 0, 4, 0xC0, 0xA0, 0xE0, 0xC0, 
  /* RLE: 006 Pixels @ 034,036*/ 6, 0xFF, 
  /* ABS: 019 Pixels @ 040,036*/ 0, 19, 0xE0, 0xA0, 0xC0, 0xC0, 0xE0, 0xE0, 0xA0, 0xFF, 0xFF, 0xFF, 0xC0, 0xE0, 0xFF, 0xFF, 0xE0, 0xE0, 0xE0, 0xFF, 0xFF, 
  /* RLE: 055 Pixels @ 059,036*/ 55, 0xE0, 
  /* ABS: 002 Pixels @ 034,037*/ 0, 2, 0xC0, 0xE0, 
  /* RLE: 014 Pixels @ 036,037*/ 14, 0xFF, 
  /* ABS: 009 Pixels @ 050,037*/ 0, 9, 0xE0, 0xE0, 0xFF, 0xFF, 0xE0, 0xE0, 0xE0, 0xFF, 0xFF, 
  /* RLE: 057 Pixels @ 059,037*/ 57, 0xE0, 
  /* RLE: 001 Pixels @ 036,038*/ 1, 0xC0, 
  /* RLE: 013 Pixels @ 037,038*/ 13, 0xFF, 
  /* ABS: 009 Pixels @ 050,038*/ 0, 9, 0xC0, 0xE0, 0xFF, 0xFF, 0xE0, 0xE0, 0xE0, 0xFF, 0xFF, 
  /* RLE: 059 Pixels @ 059,038*/ 59, 0xE0, 
  /* RLE: 001 Pixels @ 038,039*/ 1, 0xC0, 
  /* RLE: 009 Pixels @ 039,039*/ 9, 0xFF, 
  /* RLE: 004 Pixels @ 048,039*/ 4, 0xE0, 
  /* RLE: 007 Pixels @ 052,039*/ 7, 0xFF, 
  /* RLE: 073 Pixels @ 059,039*/ 73, 0xE0, 
  /* RLE: 007 Pixels @ 052,040*/ 7, 0xFF, 
  /* RLE: 073 Pixels @ 059,040*/ 73, 0xE0, 
  /* ABS: 007 Pixels @ 052,041*/ 0, 7, 0xFF, 0xFF, 0xE0, 0xE0, 0xE0, 0xFF, 0xFF, 
  /* RLE: 073 Pixels @ 059,041*/ 73, 0xE0, 
  /* ABS: 007 Pixels @ 052,042*/ 0, 7, 0xFF, 0xFF, 0xE0, 0xE0, 0xE0, 0xFF, 0xFF, 
  /* RLE: 073 Pixels @ 059,042*/ 73, 0xE0, 
  /* ABS: 007 Pixels @ 052,043*/ 0, 7, 0xFF, 0xFF, 0xE0, 0xE0, 0xE0, 0xFF, 0xFF, 
  /* RLE: 073 Pixels @ 059,043*/ 73, 0xE0, 
  /* RLE: 001 Pixels @ 052,044*/ 1, 0xE9, 
  /* RLE: 004 Pixels @ 053,044*/ 4, 0xE0, 
  /* RLE: 001 Pixels @ 057,044*/ 1, 0xE1, 
  /* RLE: 422 Pixels @ 058,044*/ 254, 0xE0, 168, 0xE0, 


  0};  /* 524 for 4000 pixels */

GUI_CONST_STORAGE GUI_BITMAP bmbmp_speed_extru = {
  80, /* XSize */
  50, /* YSize */
  80, /* BytesPerLine */
  GUI_COMPRESS_RLE8, /* BitsPerPixel */
  acbmp_speed_extru,  /* Pointer to picture data (indices) */
  &Palbmp_speed_extru  /* Pointer to palette */
 ,GUI_DRAW_RLE8
};
